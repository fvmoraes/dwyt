...
`dwyt_obsidian` is the **Brain**: memory, not code structure. For code symbols, dependencies, call paths, and impact analysis, follow the [Codebase Law](05-codebase-law.md). For how memory ages out and what survives, see [Architecture v5](03-architecture-v5.md).
