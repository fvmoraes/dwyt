...
export const T = {
  en: {
    ...
    // v5 Context Governor card. "—" is shown wherever the backend could not
    // measure a value, so the hints explain what observed vs estimated means.
    governorTitle: 'Context Governor',
    governorContextReduction: 'Context reduction',
    governorAvoidedTokens: 'Avoided tokens',
    governorCacheHit: 'Cache hit',
    governorCostObserved: 'Cost (observed)',
    governorCostEstimated: 'Cost (estimated)',
    governorCostPerTask: 'Cost / completed task',
    governorCompletion: 'Completion rate',
    governorCanonicalNotes: 'Canonical notes',
    governorSessions: 'Sessions kept',
    governorStaleNotes: 'Stale notes',
    governorExpiringSoon: 'Expiring < 24h',
    governorRawObjects: 'Raw objects',
    governorLastHousekeeping: 'Last housekeeping',
    governorNever: 'never',
    governorPreviewCleanup: 'Preview cleanup',
    governorRunCleanup: 'Run cleanup',
    governorDryRunPrefix: 'Preview:',
    governorAppliedPrefix: 'Done:',
    governorReportLine: '{sessions} sessions, {expired} expired, {stale} stale, {raw} raw objects',
    governorPromoted: '{count} knowledge item(s) promoted to canonical memory first',
    governorPartialCoverage: '* only {observed} of {total} requests reported real usage; the rest are estimates',
    governorUnavailable: 'telemetry unavailable',
    governorObservedHint: 'Sum of costs the provider actually reported. Shows — when no request reported one.',
    governorEstimatedHint: 'DWYT estimate from the local pricing catalog. Not a billing figure.',
  },
  pt: {
    ...
    // Card do Context Governor (v5). "—" aparece sempre que o backend não pôde
    // medir o valor; as dicas explicam a diferença entre observado e estimado.
    governorTitle: 'Context Governor',
    governorContextReduction: 'Redução de contexto',
    governorAvoidedTokens: 'Tokens evitados',
    governorCacheHit: 'Cache hit',
    governorCostObserved: 'Custo (observado)',
    governorCostEstimated: 'Custo (estimado)',
    governorCostPerTask: 'Custo / tarefa concluída',
    governorCompletion: 'Taxa de conclusão',
    governorCanonicalNotes: 'Notas canônicas',
    governorSessions: 'Sessões mantidas',
    governorStaleNotes: 'Notas desatualizadas',
    governorExpiringSoon: 'Expirando < 24h',
    governorRawObjects: 'Objetos brutos',
    governorLastHousekeeping: 'Última limpeza',
    governorNever: 'nunca',
    governorPreviewCleanup: 'Simular limpeza',
    governorRunCleanup: 'Executar limpeza',
    governorDryRunPrefix: 'Simulação:',
    governorAppliedPrefix: 'Concluído:',
    governorReportLine: '{sessions} sessões, {expired} expirados, {stale} desatualizados, {raw} objetos brutos',
    governorPromoted: '{count} item(ns) de conhecimento promovido(s) para a memória canônica antes',
    governorPartialCoverage: '* apenas {observed} de {total} requisições reportaram uso real; o resto é estimativa',
    governorUnavailable: 'telemetria indisponível',
    governorObservedHint: 'Soma dos custos que o provider realmente reportou. Mostra — quando nenhuma requisição reportou.',
    governorEstimatedHint: 'Estimativa da DWYT a partir do catálogo local de preços. Não é valor de cobrança.',
  },
} as const
