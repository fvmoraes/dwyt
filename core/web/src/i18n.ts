...
export const T = {
  en: {
    ...
    search: 'Search', searchPlaceholder: 'Search brain...', repoPlaceholder: 'path/to/repo',
    rebuildSummary: 'Rebuild summary', forgetMemory: 'Forget brain', forgetMemoryConfirm: 'Forget all brain data for this project?',
    saveMemory: 'Save to brain', saveMemoryPlaceholder: 'Brain note...',
    memories: 'Brain files', noMemoriesYet: 'No brain files yet',
    global: 'global',
    ...
    brainActive: 'Project Brain', compressionActive: 'Active compression',
  ...
  pt: {
    ...
    search: 'Buscar', searchPlaceholder: 'Buscar no brain...', repoPlaceholder: 'path/to/repo',
    rebuildSummary: 'Reconstruir resumo', forgetMemory: 'Apagar brain', forgetMemoryConfirm: 'Apagar todos os dados do brain?',
    saveMemory: 'Salvar no brain', saveMemoryPlaceholder: 'Nota do brain...',
    memories: 'Arquivos do brain', noMemoriesYet: 'Nenhum arquivo ainda',
    global: 'global',
    ...
    // User-friendly tool names
    brainActive: 'Project Brain', compressionActive: 'Compressão ativa',
