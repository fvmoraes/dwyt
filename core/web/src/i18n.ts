...
export const T = {
  en: {
    ...
    rebuildSummary: 'Rebuild summary', forgetMemory: 'Forget memory', forgetMemoryConfirm: 'Forget all memory for this project?',
    saveMemory: 'Save', saveMemoryPlaceholder: 'Quick note...',
    memories: 'Memories', noMemoriesYet: 'No memories yet',
    global: 'global',
    ...
    status: 'Status',
    snapshots: 'Snapshots', saveSnapshot: 'Save snapshot', restoreSnapshot: 'Restore', deleteSnapshot: 'Delete',
    noSnapshots: 'No snapshots yet', snapshotHourly: 'Hourly auto', snapshotDaily: 'Daily auto',
    snapshotSession: 'Session', snapshotManual: 'Manual',
  ...
  pt: {
    ...
    rebuildSummary: 'Reconstruir resumo', forgetMemory: 'Apagar memória', forgetMemoryConfirm: 'Apagar toda a memória deste projeto?',
    saveMemory: 'Salvar', saveMemoryPlaceholder: 'Nota rápida...',
    memories: 'Memórias', noMemoriesYet: 'Sem memórias ainda',
    global: 'global',
    ...
    status: 'Status',
    snapshots: 'Snapshots', saveSnapshot: 'Salvar snapshot', restoreSnapshot: 'Restaurar', deleteSnapshot: 'Apagar',
    noSnapshots: 'Nenhum snapshot', snapshotHourly: 'Auto 1h', snapshotDaily: 'Auto 24h',
    snapshotSession: 'Sessão', snapshotManual: 'Manual',
